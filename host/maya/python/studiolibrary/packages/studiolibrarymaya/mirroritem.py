...
class MirrorItem(baseitem.BaseItem):
    ...
    def load(
        self, objects=None, namespaces=None, option=None, animation=True, time=None
    ):
        """
    ...
    def save(
        ...
        **kwargs
        ...
        t = self.transferClass().fromObjects(
            objects, leftSide=leftSide, rightSide=rightSide
        )
        ...
        studiolibrary.LibraryItem.save(
            self, path=path, contents=[tempPath, iconPath], **kwargs
        )
...
class MirrorCreateWidget(basecreatewidget.BaseCreateWidget):
    ...
    def selectionChanged(self):
        ...
        mt = mutils.MirrorTable.fromObjects([], leftSide=leftSide, rightSide=rightSide)
