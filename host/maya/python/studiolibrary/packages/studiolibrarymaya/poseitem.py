...
from host.maya.python.studiolibrary.packages import studiolibrarymaya
...
__all__ = ["PoseItem", "PoseCreateWidget", "PosePreviewWidget"]
...
class PosePreviewWidget(basepreviewwidget.BasePreviewWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.connect(
            self.ui.mirrorCheckBox, QtCore.SIGNAL("clicked()"), self.saveSettings
        )
        self.connect(
            self.ui.blendSlider, QtCore.SIGNAL("sliderMoved(int)"), self.sliderMoved
        )
        self.connect(
            self.ui.blendSlider, QtCore.SIGNAL("sliderReleased()"), self.sliderReleased
        )
    ...
    def sliderReleased(self):
        ...
        self.item().loadFromSettings(blend=blend, refresh=False, showBlendMessage=True)
    ...
    def sliderMoved(self, value):
        ...
        :type value: float
        """
        self.item().loadFromSettings(blend=value, batchMode=True, showBlendMessage=True)
