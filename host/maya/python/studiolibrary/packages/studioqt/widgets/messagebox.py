...
def showMessageBox(
    ...
    if isinstance(dontShowAgain, str):
...
class MessageBox(QtWidgets.QDialog):
    ...
    def input(
        ...
        """
        buttons = (
            buttons or QtWidgets.QDialogButtonBox.Ok | QtWidgets.QDialogButtonBox.Cancel
        )
    ...
    def question(
        ...
        buttons = (
            buttons
            or QtWidgets.QDialogButtonBox.Yes
    ...
    def warning(
        ...
        """
        buttons = (
            buttons or QtWidgets.QDialogButtonBox.Yes | QtWidgets.QDialogButtonBox.No
        )
...
def testMessageBox():
    ...
    with studioqt.app():
        ...
        result = MessageBox.question(
            None, title, text, buttons=buttons, enableDontShowCheckBox=True
        )
        print(result)

        title = "Create a new thumbnail icon"
        text = (
            "This will override the existing thumbnail. "
