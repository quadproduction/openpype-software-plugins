...
import studioqt
from host.maya.python import studiolibrary
...
class LibraryWidget(QtWidgets.QWidget):
    ...
    def showPathErrorDialog(self):
        ...
        text = (
            'The current root path does not exist "{path}". '
    ...
    def showWelcomeDialog(self):
        ...
        text = (
            "Before you get started please choose a folder "
    ...
    def items(self):
        ...
        :rtype: list[studiolibrary.LibraryItem]
        """
        return list(self.itemsWidget().items())
    ...
    def updateItems(self):
        ...
        items = list(
            studiolibrary.findItemsInFolders(
                paths,
                depth,
                libraryWidget=self,
            )
    ...
    def createMoveItemsDialog(self):
        ...
        dialog.addButton("Copy", QtWidgets.QDialogButtonBox.AcceptRole)
        dialog.addButton("Move", QtWidgets.QDialogButtonBox.AcceptRole)
        dialog.addButton("Cancel", QtWidgets.QDialogButtonBox.RejectRole)
    ...
    def showMoveFoldersToTrashDialog(self):
        ...
        if item:
            title = "Move to trash?"
            text = (
                "Are you sure you want to move the selected " "folder/s to the trash?"
            )
    ...
    def showRefreshMessage(self, elapsedTime):
        ...
        :rtype None
        """
        itemCount = len(list(self._itemsWidget.items()))
