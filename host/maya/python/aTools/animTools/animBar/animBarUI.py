...
from host.maya.python.aTools.generalTools        import aToolsClasses;               importlib.reload(aToolsClasses)
from host.maya.python.aTools.commonMods          import animMod;                     importlib.reload(animMod)
from host.maya.python.aTools.generalTools        import generalToolsUI;              importlib.reload(generalToolsUI)
from host.maya.python.aTools.commonMods          import utilMod;                     importlib.reload(utilMod)
from host.maya.python.aTools.commonMods          import commandsMod;                 importlib.reload(commandsMod)
from host.maya.python.aTools.commonMods          import aToolsMod;                   importlib.reload(aToolsMod)
from host.maya.python.aTools                     import setup;                       importlib.reload(setup)
...
for loopMod in SUB_UI_MODS:
    exec("""import host.maya.python.aTools.animTools.animBar.subUIs.%s as %s;
import importlib;
importlib.reload(%s)"""%(loopMod, loopMod, loopMod))
