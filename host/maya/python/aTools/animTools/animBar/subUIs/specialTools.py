...
from host.maya.python.aTools.commonMods import uiMod;   importlib.reload(uiMod)
...
for loopMod in MODULES:
    exec(
        """from host.maya.python.aTools.animTools.animBar.subUIs.specialTools_subUIs import %s;
import importlib;
importlib.reload(%s)""" % (loopMod, loopMod)
    )
