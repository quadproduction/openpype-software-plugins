...
def nodeIsInside(node, backdropNode):
    ...
    topLeft = (
        (topLeftNode[0] >= topLeftBackDrop[0]) and
        (topLeftNode[1] >= topLeftBackDrop[1])
    )
    bottomRight = (
        (bottomRightNode[0] <= bottomRightBackdrop[0]) and
...
def autoBackdrop():
    ...
    if len(selectedBackdropNodes):
        zOrder = min(
            [node.knob("z_order").value() for node in selectedBackdropNodes]
        ) - 1
    else:
    ...
    n = nuke.nodes.BackdropNode(
        ...
        bdheight=bdH,
        tile_color=int(
            '%02x%02x%02x%02x' % (int(R*255), int(G*255), int(B*255), 255),
            16
        ),
...
def grow(node=None, step=50):\n
    ...
    shrink = nuke.PyScript_Knob(
        'shrink',
        '<img src="{}/F_scalem.png">'.format(icon_path),
        """
n = nuke.thisNode()\n\n
...
def shrink(node=None, step=50):\n
    ...
    colorandom = nuke.PyScript_Knob(
        'colorandom',
        '<img src="ColorBars.png">',
        """
...
n['tile_color'].setValue(
    int('%02x%02x%02x%02x' % (R, G, B, 255), 16)
)"""
    )

    red = nuke.PyScript_Knob(
        'red',
        '<img src="{}/F_r.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.0, 0.77, 0.8]\n
...
n['tile_color'].setValue(
    ...
    orange = nuke.PyScript_Knob(
        'orange',
        '<img src="{}/F_o.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.1, 0.8, 0.8]\n
...
n['tile_color'].setValue(
    ...
    yellow = nuke.PyScript_Knob(
        'yellow',
        '<img src="{}/F_y.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.16, 0.8, 0.8]\n
...
n['tile_color'].setValue(
    ...
    green = nuke.PyScript_Knob(
        'green',
        '<img src="{}/F_g.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.33, 0.8, 0.7]\n
...
n['tile_color'].setValue(
    ...
    cyan = nuke.PyScript_Knob(
        'cyan',
        '<img src="{}/F_c.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.46, 0.8, 0.7]\n
...
n['tile_color'].setValue(
    ...
    blue = nuke.PyScript_Knob(
        'blue',
        '<img src="{}/F_b.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.6, 0.7, 0.76]\n
...
n['tile_color'].setValue(
    ...
    darkblue = nuke.PyScript_Knob(
        'darkblue',
        '<img src="{}/F_db.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.67, 0.74, 0.6]\n
...
n['tile_color'].setValue(
    ...
    magenta = nuke.PyScript_Knob(
        'magenta',
        '<img src="{}/F_m.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.8, 0.74, 0.65]\n
...
n['tile_color'].setValue(
    ...
    pink = nuke.PyScript_Knob(
        'pink',
        '<img src="{}/F_p.png">'.format(icon_path),
        """
import colorsys\n
n = nuke.thisNode()\n
R, G, B = [0.92, 0.74, 0.8]\n
...
n['tile_color'].setValue(
    ...
    copyright = nuke.Text_Knob(
        "Ftools",
        "",
        "<font color=\"#1C1C1C\"> v1.2 - Franklin VFX - 2018"
    )
...
try:\n
    ...
    txt = nuke.getInput('Backdrop text', '')
    if txt:
        n['text'].setValue(txt)
